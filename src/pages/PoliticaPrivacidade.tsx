...
const PoliticaPrivacidade = () => {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Política de Privacidade e Termos de Uso - TriMundo",
    "description": "Política de privacidade e termos de uso do site TriMundo"
  };
  ...
  return (
    <>
      <SEO
        ...
        description="Política de privacidade e termos de uso do site educativo TriMundo sobre trigonometria."
